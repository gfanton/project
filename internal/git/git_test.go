...
// 	// In CI environments, SSH_AUTH_SOCK may not be set, causing SSH agent errors
// 	// In other environments, it may fail due to authentication or network issues
// 	validErrors := []string{
...
// 		if strings.Contains(err.Error(), validError) {
// 			hasValidError = true
// 			break
// 		}
// 	}
